...
const normaJar = './norma-0.7.0-alpha-jar-with-dependencies.jar';
...
NormaServices.userWorkspace = './TestWorkspace/';
var userWorkspace = NormaServices.userWorkspace;
...
NormaServices.makeProject = function (req, res) {
	...
	const child = spawn('java', ["-jar", normaJar,
															 "--project", userWorkspace + req.body.corpusName,
															 "--fileFilter", ".*/(.*)\\.pdf",	
...
NormaServices.transformPDF2SVG = function (req, res) {
	...
	var fullyQualifiedCorpusName = userWorkspace + req.body.corpusName;
